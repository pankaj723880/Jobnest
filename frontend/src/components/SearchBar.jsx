...
const SearchBar = () => {
    ...
    const popularCategories = [
        { name: 'Driver', icon: 'bi-truck' },
        { name: 'Cleaner', icon: 'bi-broom' },
        { name: 'Security', icon: 'bi-shield-lock' },
        { name: 'Sales', icon: 'bi-tag' },
        { name: 'Delivery', icon: 'bi-box' },
    ];
    ...
    const handleNearMe = () => {
        ...
        alert('Fetching jobs near your current location...');
        ...
        <div style={heroStyle} className="text-center shadow-lg">
            ...
            <div className="container position-relative z-1">
                ...
                <h1 className="display-3 fw-bolder mb-3">
                    Your Next Job is <span className="text-warning">Local.</span>
                </h1>
                <p className="lead fw-light mb-5 px-lg-5">
                    India's fastest platform for blue-collar jobs. Find verified positions from trusted employers across all major cities.
                </p>
                    ...
                    <div className="col-xl-9 col-lg-10">
                        <div className="input-group input-group-lg bg-white rounded-4 shadow-lg p-2 border-0">
                            ...
                            <button className="btn btn-warning text-dark fw-bold px-4 rounded-4" 
                                ...
                                <i className="bi bi-pin-map-fill me-1"></i> Near Me
                            </button>
                        </div>
                    </div>
                </form>
                ...
                <div className="mt-4 pt-4">
                    <span className="fw-semibold me-3 d-block d-md-inline-block mb-2 mb-md-0">Popular Searches:</span>
