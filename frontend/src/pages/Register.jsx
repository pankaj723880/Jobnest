        ...
        <ul className="nav nav-pills nav-fill mb-4 p-1 bg-light rounded-pill border">
            <li className="nav-item">
                <button
                    ...
                    disabled={isLoading}
                >
                    <i className="bi bi-person-fill me-2"></i> Register as Worker
                </button>
            </li>
            <li className="nav-item">
                <button
                    ...
                    disabled={isLoading}
                >
                    <i className="bi bi-building-fill me-2"></i> Register as Employer
                </button>
            </li>
        </ul>
    );
                ...
                <div className="col-md-8 col-lg-7">
                    <div className="card shadow-lg border-0 rounded-4">
                        <div className="card-header bg-white text-center rounded-top-4 py-3">
                            <h2 className="mb-0 fw-bold text-dark">Join Jobnest Today!</h2>
                            <p className="mb-0 small text-muted">A few simple steps to get started.</p>
                        </div>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="form-text">
                                        Your email will be securely used for communication.
                                    </div>
                                </div>
                                ...
                                >
                                    {isLoading ? (
                                        ...
                                        `Create Account as ${role === 'worker' ? 'Worker' : 'Employer'}`
                                    )}
                                </button>
                            </form>
                        </div>
